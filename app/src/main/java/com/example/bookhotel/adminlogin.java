    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent( adminlogin.this,starter.class);
            ...
            if(validL)
            {
                ...
                firebaseAuth.signInWithEmailAndPassword(email.getText().toString(),password.getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        startActivity(new Intent(getApplicationContext(),adminside_dashbord.class));
                        finish();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(adminlogin.this, "Incorrect Info Try Again", Toast.LENGTH_SHORT).show();
